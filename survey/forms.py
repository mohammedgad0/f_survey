...
def dropDownList(rp_id, lookup_id, l_list_active,type = 'select'):
    CHOICES = []
    if type == 'select':
...
class FamilyMemberFormStep1(forms.ModelForm):
    ...
    difficulty_2_degree = forms.ChoiceField(required=False, widget=forms.RadioSelect(attrs={'class': ' form-control'}), choices=dropDownList(rp_id=9, lookup_id=173, l_list_active=1, type='radio'), label='درجةالصعوبة')
    difficulty_3 = forms.NullBooleanField(label='الحركة', required=False,  widget=forms.CheckboxInput(attrs={'class':'require-one'}))
    difficulty_3_degree = forms.ChoiceField(required=False, widget=forms.RadioSelect(attrs={'class': ' form-control'}), choices=dropDownList(rp_id=9, lookup_id=173, l_list_active=1, type='radio'), label='درجةالصعوبة')
    difficulty_4 = forms.NullBooleanField(label='التزكر', required=False,  widget=forms.CheckboxInput(attrs={'class':'require-one'}))
    difficulty_4_degree = forms.ChoiceField(required=False, widget=forms.RadioSelect(attrs={'class': ' form-control'}), choices=dropDownList(rp_id=9, lookup_id=173, l_list_active=1, type='radio'), label='درجةالصعوبة')
    ...
    difficulty_5_degree = forms.ChoiceField(required=False, widget=forms.RadioSelect(attrs={'class': ' form-control'}), choices=dropDownList(rp_id=9, lookup_id=173, l_list_active=1, type='radio'), label='درجةالصعوبة')
    ...
    difficulty_6_degree = forms.ChoiceField(required=False, widget=forms.RadioSelect(attrs={'class': ' form-control'}), choices=dropDownList(rp_id=9, lookup_id=173, l_list_active=1, type='radio'), label='درجةالصعوبة')
    ...
    difficulty_7_degree = forms.ChoiceField(required=False, widget=forms.RadioSelect(attrs={'class': ' form-control'}), choices=dropDownList(rp_id=9, lookup_id=173, l_list_active=1, type='radio'), label='درجةالصعوبة')
...
class AddHouse(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'bed_room_count': TextInput(attrs={'required': True, 'type': 'number', 'min': 0, 'step': 1, 'pattern': "\d*", 'oninput': "validity.valid||(value='');", 'onKeyPress': 'if(this.value.length==2) return false;'}),
            'other_room_count': TextInput(attrs={'required': True, 'type': 'number', 'min': 0, 'step': 1, 'pattern': "\d*", 'oninput': "validity.valid||(value='');", 'onKeyPress': 'if(this.value.length==2) return false;'}),
            'kitchen_count': TextInput(attrs={'required': True, 'type': 'number', 'min': 0, 'step': 1, 'pattern': "\d*", 'oninput': "validity.valid||(value='');", 'onKeyPress': 'if(this.value.length==2) return false;'}),
            'bath_room_count': TextInput(attrs={'required': True, 'type': 'number', 'min': 0, 'step': 1, 'pattern': "\d*", 'oninput': "validity.valid||(value='');", 'onKeyPress': 'if(this.value.length==2) return false;'}),
            'mobile_count': TextInput(attrs={'required': True, 'type': 'number', 'min': 0, 'step': 1, 'pattern': "\d*", 'oninput': "validity.valid||(value='');", 'onKeyPress': 'if(this.value.length==2) return false;'}),
            'telephone_count': TextInput(attrs={'required': True, 'type': 'number', 'min': 0, 'step': 1, 'pattern': "\d*", 'oninput': "validity.valid||(value='');", 'onKeyPress': 'if(this.value.length==2) return false;'}),
            'internet_users_count': TextInput(attrs={'required': True, 'type': 'number', 'min': 0, 'step': 1, 'pattern': "\d*", 'oninput': "validity.valid||(value='');", 'onKeyPress': 'if(this.value.length==2) return false;'}),
            'car_count': TextInput(attrs={'required': True, 'type': 'number', 'min': 0, 'step': 1, 'pattern': "\d*", 'oninput': "validity.valid||(value='');", 'onKeyPress': 'if(this.value.length==2) return false;'}),
            'tv_count': TextInput(attrs={'required': True, 'type': 'number', 'min': 0, 'step': 1, 'pattern': "\d*", 'oninput': "validity.valid||(value='');", 'onKeyPress': 'if(this.value.length==2) return false;'}),
        }
...
class DeathForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'member_name': TextInput(attrs={'required': True, 'type': 'text'})
        }
