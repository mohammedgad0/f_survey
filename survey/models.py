...
class FcpFamilyMemberTab(models.Model):
    ...
    family_relation = models.CharField(max_length=200,blank=True, null=True)
    ...
    study_field = models.CharField(max_length=250, blank=True, null=True)
    marital_status = models.CharField(max_length=250, blank=True, null=True)
    males_count = models.CharField(max_length=250, blank=True, null=True)
    females_count = models.CharField(max_length=250, blank=True, null=True)
    labor_status = models.CharField(max_length=250, blank=True, null=True)
    labor_status_txt = models.CharField( max_length=250, blank=True, null=True)
    main_job = models.CharField(max_length=250, blank=True, null=True)
    economic_activity = models.CharField(max_length=250, blank=True, null=True)
    work_sector_type = models.CharField(max_length=250, blank=True, null=True)
